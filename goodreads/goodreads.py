...
def pick_quote(random_word):
    '''
    Takes a word either generated at random or parsed from the user's book selection. 
    Searches Goodreads Quotes for this word and returns the top quote that includes this word. 
    '''
    browser = webdriver.Chrome(service=Service(ChromeDriverManager().install()))
    browser.get('https://www.goodreads.com/quotes')
    time.sleep(3)
